package com.pankaj.urlshortener.domain.entities;
...
public class ShortUrl {
    ...
    private com.pankaj.urlshortener.domain.entities.User createdBy;
    ...
    public com.pankaj.urlshortener.domain.entities.User getCreatedBy() {
        return createdBy;
    }

    public void setCreatedBy(com.pankaj.urlshortener.domain.entities.User createdBy) {
